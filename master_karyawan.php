    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="master_karyawan.php">Data Karyawan</a></li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                ...
                <div class="">
                <a href="form_karyawan_tambah.php" class="btn btn-primary ">Tambah Data Karyawan</a>
                </div>
