                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group m-b"><span class="input-group-addon">Nama List</span> <input type="text" class="form-control"> <span class="input-group-btn"> <button type="submit" class="btn btn-primary">Tambah
                                        </button> </span></div>
                                    </div>
                                </div>
                            </form>
